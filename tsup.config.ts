...
export default defineConfig({
  entry: [
    ...
    // Analytics + sentiment chart components
    "src/entries/analytics-bar-chart.ts",
    "src/entries/analytics-word-cloud.ts",
  ...
  sourcemap: true,
  clean: true,
  external: ["react", "react-dom", /^prosemirror-/, "recharts", "@isoterik/react-word-cloud"],
  treeshake: true,
