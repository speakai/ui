  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      >
        {/* Absolute inner box: a flex item sized only by min-height is not a definite
            height, so ResponsiveContainer's height:100% would resolve to 0 in any card
            that does not set its own height. Positioning out of flow breaks that cycle. */}
